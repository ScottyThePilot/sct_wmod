...
COMPONENT_NAMED(hk_ris1,sct_wmod_component_hk_ris1,"$STR_sct_wmod_c_hk_ris1");
COMPONENT_NAMED(hk_ris2,sct_wmod_component_hk_ris2,"$STR_sct_wmod_c_hk_ris2");
COMPONENT_NAMED(hk_tac,sct_wmod_component_hk_tac,"$STR_sct_wmod_c_hk_tac");
